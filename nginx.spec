...
Source0: https://nginx.org/download/%{name}-%{version}.tar
Source1: logrotate
Source2: nginx.conf
...
tar -xvf /home/abuild/rpmbuild/SOURCES/nginx-module-vts.tar.gz -C .
tar -xvf /home/abuild/rpmbuild/SOURCES/ngx_cache_purge.tar.gz -C .
tar -xvf /home/abuild/rpmbuild/SOURCES/spnego-http-auth-nginx-module.tar.gz -C .
echo "---------"
ls -la
